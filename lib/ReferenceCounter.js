!function() {
    ...
    var   Class                     = require('ee-class')
        ...
        , refernceCounterSelector   = require('./RefernceCounterSelector');
    ...
    module.exports = new Class({
        ...
        , init: function init(options) {
            ...
            if (!RefernceCounterSelector) RefernceCounterSelector = refernceCounterSelector(this);

            // make the selector available on the orm
            this.selectors.push(RefernceCounterSelector);
        ...
        , onBeforePrepare: function(resource, definition) {
            ...
            if (query.order && query.order.length) {
                ...
                query.select.forEach(function(selection) {
                    if (selection instanceof RefernceCounterSelector) {
                ...
                // make sure the order statment is not adde to the group by statement
